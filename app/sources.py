...
SOURCE_CLASSIFICATION: Dict[str, Dict[str, object]] = {
    ...
    "openai-news": {"confidence": "alta", "relevance": "alta", "profiles": ["strict", "balanced", "wide"], "tags": ["ai", "vendor"]},
    "deepmind-blog": {"confidence": "alta", "relevance": "alta", "profiles": ["strict", "balanced", "wide"], "tags": ["ai", "research"]},
    "anthropic-news": {"confidence": "alta", "relevance": "alta", "profiles": ["strict", "balanced", "wide"], "tags": ["ai", "vendor"]},
    "mit-ai-topic": {"confidence": "alta", "relevance": "alta", "profiles": ["strict", "balanced", "wide"], "tags": ["ai", "media"]},
    "venturebeat-ai": {"confidence": "media", "relevance": "alta", "profiles": ["balanced", "wide"], "tags": ["ai", "media"]},
    "the-decoder": {"confidence": "media", "relevance": "alta", "profiles": ["balanced", "wide"], "tags": ["ai", "media"]},
    "techcrunch-ai": {"confidence": "media", "relevance": "alta", "profiles": ["balanced", "wide"], "tags": ["ai", "media"]},
    "arstechnica-ai": {"confidence": "media", "relevance": "alta", "profiles": ["balanced", "wide"], "tags": ["ai", "media"]},
    "wired-ai": {"confidence": "media", "relevance": "alta", "profiles": ["balanced", "wide"], "tags": ["ai", "media"]},
    "reuters-ai": {"confidence": "alta", "relevance": "alta", "profiles": ["balanced", "wide"], "tags": ["ai", "media"]},
    "arxiv-cs-ai": {"confidence": "alta", "relevance": "alta", "profiles": ["strict", "balanced", "wide"], "tags": ["ai", "research"]},
    "paperswithcode": {"confidence": "alta", "relevance": "alta", "profiles": ["strict", "balanced", "wide"], "tags": ["ai", "research"]},
    "huggingface-papers": {"confidence": "alta", "relevance": "alta", "profiles": ["strict", "balanced", "wide"], "tags": ["ai", "research"]},
    "semantic-scholar": {"confidence": "alta", "relevance": "alta", "profiles": ["strict", "balanced", "wide"], "tags": ["ai", "research"]},
    "aisi-uk": {"confidence": "alta", "relevance": "alta", "profiles": ["strict", "balanced", "wide"], "tags": ["ai", "policy"]},
    "alignment-forum": {"confidence": "media", "relevance": "media", "profiles": ["balanced", "wide"], "tags": ["ai", "alignment"]},
    "lesswrong-ai": {"confidence": "media", "relevance": "media", "profiles": ["balanced", "wide"], "tags": ["ai", "alignment"]},
    "huggingface-main": {"confidence": "alta", "relevance": "alta", "profiles": ["strict", "balanced", "wide"], "tags": ["ai", "platform"]},
    "langchain-blog": {"confidence": "alta", "relevance": "alta", "profiles": ["strict", "balanced", "wide"], "tags": ["ai", "tooling"]},
    "ollama-blog": {"confidence": "alta", "relevance": "alta", "profiles": ["strict", "balanced", "wide"], "tags": ["ai", "tooling"]},
    "mistral-news": {"confidence": "alta", "relevance": "alta", "profiles": ["strict", "balanced", "wide"], "tags": ["ai", "vendor"]},
    "futuretools": {"confidence": "media", "relevance": "media", "profiles": ["wide"], "tags": ["ai", "tooling"]},
    "theres-an-ai-for-that": {"confidence": "media", "relevance": "media", "profiles": ["wide"], "tags": ["ai", "tooling"]},
    "bensbites": {"confidence": "media", "relevance": "media", "profiles": ["wide"], "tags": ["ai", "newsletter"]},
    "superhuman-ai": {"confidence": "media", "relevance": "media", "profiles": ["wide"], "tags": ["ai", "newsletter"]},
}
...
SOURCE_REGISTRY: List[SourceConfig] = [
    ...
    SourceConfig("openai-news", "OpenAI News", "https://openai.com/news", "https://openai.com/news/rss.xml"),
    SourceConfig("deepmind-blog", "Google DeepMind Blog", "https://deepmind.google/discover/blog/", "https://deepmind.google/discover/blog/rss.xml"),
    SourceConfig("anthropic-news", "Anthropic News", "https://www.anthropic.com/news", None),
    SourceConfig("mit-ai-topic", "MIT Technology Review - AI", "https://www.technologyreview.com/topic/artificial-intelligence/", None),
    SourceConfig("venturebeat-ai", "VentureBeat AI", "https://venturebeat.com/ai/", "https://venturebeat.com/category/ai/feed/"),
    SourceConfig("the-decoder", "THE DECODER", "https://the-decoder.com/", "https://the-decoder.com/feed/"),
    SourceConfig("techcrunch-ai", "TechCrunch AI", "https://techcrunch.com/category/artificial-intelligence/", "https://techcrunch.com/category/artificial-intelligence/feed/"),
    SourceConfig("arstechnica-ai", "Ars Technica AI", "https://arstechnica.com/ai/", "https://feeds.arstechnica.com/arstechnica/technology-lab"),
    SourceConfig("wired-ai", "Wired AI", "https://www.wired.com/tag/artificial-intelligence/", None),
    SourceConfig("reuters-ai", "Reuters AI", "https://www.reuters.com/technology/artificial-intelligence/", None),
    SourceConfig("arxiv-cs-ai", "arXiv cs.AI", "https://arxiv.org/list/cs.AI/recent", "https://export.arxiv.org/rss/cs.AI"),
    SourceConfig("paperswithcode", "Papers with Code", "https://paperswithcode.com/", None),
    SourceConfig("huggingface-papers", "Hugging Face Papers", "https://huggingface.co/papers", None),
    SourceConfig("semantic-scholar", "Semantic Scholar", "https://www.semanticscholar.org/", None),
    SourceConfig("aisi-uk", "AISI UK", "https://www.aisi.gov.uk/", None),
    SourceConfig("alignment-forum", "Alignment Forum", "https://www.alignmentforum.org/", "https://www.alignmentforum.org/feed.xml"),
    SourceConfig("lesswrong-ai", "LessWrong AI", "https://www.lesswrong.com/tag/ai", "https://www.lesswrong.com/tag/ai/feed.xml"),
    SourceConfig("huggingface-main", "Hugging Face", "https://huggingface.co/", None),
    SourceConfig("langchain-blog", "LangChain Blog", "https://blog.langchain.dev/", "https://blog.langchain.dev/rss/"),
    SourceConfig("ollama-blog", "Ollama Blog", "https://ollama.com/blog", "https://ollama.com/blog/rss.xml"),
    SourceConfig("mistral-news", "Mistral AI News", "https://mistral.ai/news/", None),
    SourceConfig("futuretools", "FutureTools", "https://www.futuretools.io/", None),
    SourceConfig("theres-an-ai-for-that", "There's An AI For That", "https://theresanaiforthat.com/", None),
    SourceConfig("bensbites", "Ben's Bites", "https://www.bensbites.com/", None),
    SourceConfig("superhuman-ai", "Superhuman AI", "https://www.superhuman.ai/", None),
]
